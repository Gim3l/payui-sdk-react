...
import PayUISDK from './direflow-components/payui-sdk';

PayUISDK.then((element) => {
	console.log(element.getAttribute('api-key'));

	/**
	 * Access DOM node when it's mounted
	 */
	console.log('payui-sdk is mounted on the DOM', element);
});
